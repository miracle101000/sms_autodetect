...
public class SmsAutodetectPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler {
    ...
    private SmsAutodetectPlugin(Registrar registrar) {
    ...
    public static void registerWith(Registrar registrar) {
        new SmsAutodetectPlugin(registrar);
    }
            ...
            case "listenForCode":
                ...
                task.addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        ContextCompat.registerReceiver(activity.getApplicationContext(),
                                broadcastReceiver, intentFilter,
                                2);
                        // }
                        // activity.registerReceiver(broadcastReceiver, SmsRetriever.SEND_PERMISSION,
                        // intentFilter);
                        result.success(null);
                    }
                });
     ...
     * method as a
     * convenience. The {@code binding} may be referenced during the execution of
     * this method, but it
     ...
     * signifies that a new
     * {@link Activity} has been created with the new configuration options. That
     * method
     * provides a new {@link ActivityPluginBinding}, which references the newly
     ...
     * until
     * either {@link #onDetachedFromActivityForConfigChanges()} or
     * {@link #onDetachedFromActivity()}
     * is invoked. At the conclusion of either of those methods, the binding is no
     * longer valid. Clear
     * any references to the binding or its resources, and do not invoke any further
     * methods on the
